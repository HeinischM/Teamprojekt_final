...
def create_NN_with_temp(number_of_epochs = 10, show_model_architecture = True, show_grafics = False, show_train_eval = True, verbose = 1, model_save_path = '', temperature = 1, dataset = datasets.fashion_mnist, class_names = [], with_softlabels = False, softlabels = None):
    # Loading images
...
model = create_NN_with_temp(number_of_epochs = 50, show_model_architecture = True, show_grafics = False, show_train_eval = True, model_save_path = "./models/model_1_50epochs_mnist", temperature = 40, dataset = datasets.fashion_mnist, class_names = names, with_softlabels = False)
print('Model_1 is done and saved!')

#model = models.load_model("./models/model_1_50epochs_mnist")

###########################################################################################################
#creating (or loading) Soft Labels
train_soft_labels = create_softlabels(datasets.fashion_mnist, savepath = "softlabel_50epochs_mnist", model = model)

#train_soft_labels = np.load('softlabel_50epochs_mnist.npy')
...
model = create_NN_with_temp(number_of_epochs = 50, show_model_architecture = True, show_grafics = False, show_train_eval = True, model_save_path = "./models/model_2_50epochs_mnist", temperature = 40, dataset = datasets.fashion_mnist, class_names = names, with_softlabels = True, softlabels = train_soft_labels)
print('Model_2 training is done!')

#model = models.load_model("./models/model_2_50epochs_mnist")
...
model_d.save("./models/model_d_50epochs_mnist")